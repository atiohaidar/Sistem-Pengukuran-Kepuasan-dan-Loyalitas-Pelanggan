<x-guest-layout title="Survei Selesai - Terima Kasih">
    <div class="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto">
                        ...
                        <div>
                            ...
                            <div class="space-y-3">
                                <div class="flex justify-between">
                                    ...
                                    <code
                                        class="bg-gray-100 px-2 py-1 rounded text-sm">{{ $survey->session_token }}</code>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-gray-600">Waktu Mulai:</span>
                                    <span
                                        class="font-medium">{{ $survey->started_at ? $survey->started_at->format('d/m/Y H:i') : '-' }}</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-gray-600">Waktu Selesai:</span>
                                    <span
                                        class="font-medium">{{ $survey->completed_at ? $survey->completed_at->format('d/m/Y H:i') : '-' }}</span>
                                </div>
                                <div class="flex justify-between">
                                ...
                                <div>
                                    ...
                                    <div class="w-full bg-gray-200 rounded-full h-2">
                                        <div class="bg-blue-600 h-2 rounded-full"
                                            style="width: {{ $survey->profile_data ? '100%' : '0%' }}"></div>
                                    </div>
                                </div>
                                <div>
                                    <div class="flex justify-between text-sm mb-1">
                                    ...
                                    <div class="w-full bg-gray-200 rounded-full h-2">
                                        <div class="bg-green-600 h-2 rounded-full"
                                            style="width: {{ $survey->harapan_answers ? '100%' : '0%' }}"></div>
                                    </div>
                                </div>
                                <div>
                                    <div class="flex justify-between text-sm mb-1">
                                    ...
                                    <div class="w-full bg-gray-200 rounded-full h-2">
                                        <div class="bg-purple-600 h-2 rounded-full"
                                            style="width: {{ $survey->persepsi_answers ? '100%' : '0%' }}"></div>
                                    </div>
                                </div>
                                <div>
                                    <div class="flex justify-between text-sm mb-1">
                                    ...
                                    <div class="w-full bg-gray-200 rounded-full h-2">
                                        <div class="bg-yellow-600 h-2 rounded-full"
                                            style="width: {{ $survey->kepuasan_answers ? '100%' : '0%' }}"></div>
                                    </div>
                                </div>
                                <div>
                                    <div class="flex justify-between text-sm mb-1">
                                    ...
                                    <div class="w-full bg-gray-200 rounded-full h-2">
                                        <div class="bg-orange-600 h-2 rounded-full"
                                            style="width: {{ $survey->loyalitas_answers ? '100%' : '0%' }}"></div>
                                    </div>
                                </div>
                                <div>
                                    <div class="flex justify-between text-sm mb-1">
                                    ...
                                    <div class="w-full bg-gray-200 rounded-full h-2">
                                        <div class="bg-red-600 h-2 rounded-full"
                                            style="width: {{ $survey->feedback_answers ? '100%' : '0%' }}"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <!-- Action Buttons -->
            <div class="text-center">
                <a href="{{ route('survey.index', $type) }}"
                    class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-8 rounded-lg text-lg transition duration-300 transform hover:scale-105 shadow-lg inline-block">
