...
class GrafikController extends Controller
{
    ...
    public function grafik6()
    {
        ...
        $l1_rata_rata = $l1_rata_count > 0 ? $l1_rata_sum / $l1_rata_count : 0;
        ...
        $l2_rata_rata = $l2_rata_count > 0 ? $l2_rata_sum / $l2_rata_count : 0;
        ...
        $l3_rata_rata = $l3_rata_count > 0 ? $l3_rata_sum / $l3_rata_count : 0;
    ...
    public function grafik5()
    {
        ...
        if($total_usia25_lk !== 0){
            $persentase_usia25_lk = $totalresponden > 0 ? ($total_usia25_lk/$total_usia25) : 0*100;
        }else{
         ...
         if($total_usia25_34_lk !== 0){
            $persentase_usia25_34_lk = $totalresponden > 0 ? ($total_usia25_34_lk/$total_usia25_34) : 0*100;
        }else{
        ...
        if($total_usia35_44_lk !== 0){
            $persentase_usia35_44_lk = $totalresponden > 0 ? ($total_usia35_44_lk/$total_usia35_44) : 0*100;
        }else{
            $persentase_usia35_44_lk = 0;
        }
         //hitung persentase usia 45-54 tahun laki-laki
        if($total_usia45_54_lk !== 0){
           $persentase_usia45_54_lk = $totalresponden > 0 ? ($total_usia45_54_lk/$total_usia45_54) : 0*100;
        }else{
         ...
         if($total_usia55_64_lk !== 0){
            $persentase_usia55_64_lk = $totalresponden > 0 ? ($total_usia55_64_lk/$total_usia55_64) : 0*100;
         }else{
        ...
        if($total_usia64_lk !== 0){
            $persentase_usia64_lk = $totalresponden > 0 ? ($total_usia64_lk/$total_usia64) : 0*100;
        }else{
         ...
         if($total_usia25_pr !== 0){
            $persentase_usia25_pr = $totalresponden > 0 ? ($total_usia25_pr/$total_usia25) : 0*100;
        }else{
         ...
         if($total_usia25_34_pr !== 0){
            $persentase_usia25_34_pr = $totalresponden > 0 ? ($total_usia25_34_pr/$total_usia25_34) : 0*100;
        }else{
         ...
         if($total_usia35_44_pr !== 0){
            $persentase_usia35_44_pr = $totalresponden > 0 ? ($total_usia35_44_pr/$total_usia35_44) : 0*100;
        }else{
         ...
         if($total_usia45_54_pr !== 0){
            $persentase_usia45_54_pr = $totalresponden > 0 ? ($total_usia45_54_pr/$total_usia45_54) : 0*100;
        }else{
         ...
         if($total_usia55_64_pr !== 0){
            $persentase_usia55_64_pr = $totalresponden > 0 ? ($total_usia55_64_pr/$total_usia55_64) : 0*100;
        }else{
    ...
    public function grafik2()
    {
        ...
        $r1_ratapersepsi_rata = $r1_ratapersepsi_count > 0 ? $r1_ratapersepsi_sum / $r1_ratapersepsi_count : 0;
        ...
        $r2_ratapersepsi_rata = $r2_ratapersepsi_count > 0 ? $r2_ratapersepsi_sum / $r2_ratapersepsi_count : 0;
        ...
        $r3_ratapersepsi_rata = $r3_ratapersepsi_count > 0 ? $r3_ratapersepsi_sum / $r3_ratapersepsi_count : 0;
        ...
        $r4_ratapersepsi_rata = $r4_ratapersepsi_count > 0 ? $r4_ratapersepsi_sum / $r4_ratapersepsi_count : 0;
        ...
        $r5_ratapersepsi_rata = $r5_ratapersepsi_count > 0 ? $r5_ratapersepsi_sum / $r5_ratapersepsi_count : 0;
        ...
        $r6_ratapersepsi_rata = $r6_ratapersepsi_count > 0 ? $r6_ratapersepsi_sum / $r6_ratapersepsi_count : 0;
        ...
        $r7_ratapersepsi_rata = $r7_ratapersepsi_count > 0 ? $r7_ratapersepsi_sum / $r7_ratapersepsi_count : 0;
        ...
        $a1_ratapersepsi_rata = $a1_ratapersepsi_count > 0 ? $a1_ratapersepsi_sum / $a1_ratapersepsi_count : 0;
        ...
        $a2_ratapersepsi_rata = $a2_ratapersepsi_count > 0 ? $a2_ratapersepsi_sum / $a2_ratapersepsi_count : 0;
        ...
        $a3_ratapersepsi_rata = $a3_ratapersepsi_count > 0 ? $a3_ratapersepsi_sum / $a3_ratapersepsi_count : 0;
        ...
        $a4_ratapersepsi_rata = $a4_ratapersepsi_count > 0 ? $a4_ratapersepsi_sum / $a4_ratapersepsi_count : 0;
        ...
        $t1_ratapersepsi_rata = $t1_ratapersepsi_count > 0 ? $t1_ratapersepsi_sum / $t1_ratapersepsi_count : 0;
        ...
        $t2_ratapersepsi_rata = $t2_ratapersepsi_count > 0 ? $t2_ratapersepsi_sum / $t2_ratapersepsi_count : 0;
        ...
        $t3_ratapersepsi_rata = $t3_ratapersepsi_count > 0 ? $t3_ratapersepsi_sum / $t3_ratapersepsi_count : 0;
        ...
        $t4_ratapersepsi_rata = $t4_ratapersepsi_count > 0 ? $t4_ratapersepsi_sum / $t4_ratapersepsi_count : 0;
        ...
        $t5_ratapersepsi_rata = $t5_ratapersepsi_count > 0 ? $t5_ratapersepsi_sum / $t5_ratapersepsi_count : 0;
        ...
        $t6_ratapersepsi_rata = $t6_ratapersepsi_count > 0 ? $t6_ratapersepsi_sum / $t6_ratapersepsi_count : 0;
        ...
        $e1_ratapersepsi_rata = $e1_ratapersepsi_count > 0 ? $e1_ratapersepsi_sum / $e1_ratapersepsi_count : 0;
        ...
        $e2_ratapersepsi_rata = $e2_ratapersepsi_count > 0 ? $e2_ratapersepsi_sum / $e2_ratapersepsi_count : 0;
        ...
        $e3_ratapersepsi_rata = $e3_ratapersepsi_count > 0 ? $e3_ratapersepsi_sum / $e3_ratapersepsi_count : 0;
        ...
        $e4_ratapersepsi_rata = $e4_ratapersepsi_count > 0 ? $e4_ratapersepsi_sum / $e4_ratapersepsi_count : 0;
        ...
        $e5_ratapersepsi_rata = $e5_ratapersepsi_count > 0 ? $e5_ratapersepsi_sum / $e5_ratapersepsi_count : 0;
        ...
        $rs1_ratapersepsi_rata = $rs1_ratapersepsi_count > 0 ? $rs1_ratapersepsi_sum / $rs1_ratapersepsi_count : 0;
        ...
        $rs2_ratapersepsi_rata = $rs2_ratapersepsi_count > 0 ? $rs2_ratapersepsi_sum / $rs2_ratapersepsi_count : 0;
        ...
        $rl1_ratapersepsi_rata = $rl1_ratapersepsi_count > 0 ? $rl1_ratapersepsi_sum / $rl1_ratapersepsi_count : 0;
        ...
        $rl2_ratapersepsi_rata = $rl2_ratapersepsi_count > 0 ? $rl2_ratapersepsi_sum / $rl2_ratapersepsi_count : 0;
        ...
        $r1_ratakepentingan_rata = $r1_ratakepentingan_count > 0 ? $r1_ratakepentingan_sum / $r1_ratakepentingan_count : 0;
        ...
        $r2_ratakepentingan_rata = $r2_ratakepentingan_count > 0 ? $r2_ratakepentingan_sum / $r2_ratakepentingan_count : 0;
        ...
        $r3_ratakepentingan_rata = $r3_ratakepentingan_count > 0 ? $r3_ratakepentingan_sum / $r3_ratakepentingan_count : 0;
        ...
        $r4_ratakepentingan_rata = $r4_ratakepentingan_count > 0 ? $r4_ratakepentingan_sum / $r4_ratakepentingan_count : 0;
        ...
        $r5_ratakepentingan_rata = $r5_ratakepentingan_count > 0 ? $r5_ratakepentingan_sum / $r5_ratakepentingan_count : 0;
        ...
        $r6_ratakepentingan_rata = $r6_ratakepentingan_count > 0 ? $r6_ratakepentingan_sum / $r6_ratakepentingan_count : 0;
        ...
        $r7_ratakepentingan_rata = $r7_ratakepentingan_count > 0 ? $r7_ratakepentingan_sum / $r7_ratakepentingan_count : 0;
        ...
        $a1_ratakepentingan_rata = $a1_ratakepentingan_count > 0 ? $a1_ratakepentingan_sum / $a1_ratakepentingan_count : 0;
        ...
        $a2_ratakepentingan_rata = $a2_ratakepentingan_count > 0 ? $a2_ratakepentingan_sum / $a2_ratakepentingan_count : 0;
        ...
        $a3_ratakepentingan_rata = $a3_ratakepentingan_count > 0 ? $a3_ratakepentingan_sum / $a3_ratakepentingan_count : 0;
        ...
        $a4_ratakepentingan_rata = $a4_ratakepentingan_count > 0 ? $a4_ratakepentingan_sum / $a4_ratakepentingan_count : 0;
        ...
        $t1_ratakepentingan_rata = $t1_ratakepentingan_count > 0 ? $t1_ratakepentingan_sum / $t1_ratakepentingan_count : 0;
        ...
        $t2_ratakepentingan_rata = $t2_ratakepentingan_count > 0 ? $t2_ratakepentingan_sum / $t2_ratakepentingan_count : 0;
        ...
        $t3_ratakepentingan_rata = $t3_ratakepentingan_count > 0 ? $t3_ratakepentingan_sum / $t3_ratakepentingan_count : 0;
        ...
        $t4_ratakepentingan_rata = $t4_ratakepentingan_count > 0 ? $t4_ratakepentingan_sum / $t4_ratakepentingan_count : 0;
        ...
        $t5_ratakepentingan_rata = $t5_ratakepentingan_count > 0 ? $t5_ratakepentingan_sum / $t5_ratakepentingan_count : 0;
        ...
        $t6_ratakepentingan_rata = $t6_ratakepentingan_count > 0 ? $t6_ratakepentingan_sum / $t6_ratakepentingan_count : 0;
        ...
        $e1_ratakepentingan_rata = $e1_ratakepentingan_count > 0 ? $e1_ratakepentingan_sum / $e1_ratakepentingan_count : 0;
        ...
        $e2_ratakepentingan_rata = $e2_ratakepentingan_count > 0 ? $e2_ratakepentingan_sum / $e2_ratakepentingan_count : 0;
        ...
        $e3_ratakepentingan_rata = $e3_ratakepentingan_count > 0 ? $e3_ratakepentingan_sum / $e3_ratakepentingan_count : 0;
        ...
        $e4_ratakepentingan_rata = $e4_ratakepentingan_count > 0 ? $e4_ratakepentingan_sum / $e4_ratakepentingan_count : 0;
        ...
        $e5_ratakepentingan_rata = $e5_ratakepentingan_count > 0 ? $e5_ratakepentingan_sum / $e5_ratakepentingan_count : 0;
        ...
        $rs1_ratakepentingan_rata = $rs1_ratakepentingan_count > 0 ? $rs1_ratakepentingan_sum / $rs1_ratakepentingan_count : 0;
        ...
        $rs2_ratakepentingan_rata = $rs2_ratakepentingan_count > 0 ? $rs2_ratakepentingan_sum / $rs2_ratakepentingan_count : 0;
        ...
        $rl1_ratakepentingan_rata = $rl1_ratakepentingan_count > 0 ? $rl1_ratakepentingan_sum / $rl1_ratakepentingan_count : 0;
        ...
        $rl2_ratakepentingan_rata = $rl2_ratakepentingan_count > 0 ? $rl2_ratakepentingan_sum / $rl2_ratakepentingan_count : 0;
        ...
        $wf_rs1 = $totalharapan > 0 ? $rs1_ratakepentingan_rata/$totalharapan : 0;
        $ws_rs1 = $rs1_ratapersepsi_rata*$wf_rs1;
        $gap_rs1 = $rs1_ratapersepsi_rata-$rs1_ratakepentingan_rata;

        $wf_rs2 = $totalharapan > 0 ? $rs2_ratakepentingan_rata/$totalharapan : 0;
        ...
        $wf_rl1 = $totalharapan > 0 ? $rl1_ratakepentingan_rata/$totalharapan : 0;
        $ws_rl1 = $rl1_ratapersepsi_rata*$wf_rl1;
        $gap_rl1 = $rl1_ratapersepsi_rata-$rl1_ratakepentingan_rata;

        $wf_rl2 = $totalharapan > 0 ? $rl2_ratakepentingan_rata/$totalharapan : 0;
    ...
    public function grafik3()
    {
        ...
        //$a5_ratapersepsi_rata = $a5_ratapersepsi_count > 0 ? $a5_ratapersepsi_sum / $a5_ratapersepsi_count : 0;
        ...
        //$a5_ratakepentingan_rata = $a5_ratakepentingan_count > 0 ? $a5_ratakepentingan_sum / $a5_ratakepentingan_count : 0;
        ...
        //$e6_ratapersepsi_rata = $e6_ratapersepsi_count > 0 ? $e6_ratapersepsi_sum / $e6_ratapersepsi_count : 0;
        ...
        //$e6_ratakepentingan_rata = $e6_ratakepentingan_count > 0 ? $e6_ratakepentingan_sum / $e6_ratakepentingan_count : 0;
        ...
        //$rs3_ratapersepsi_rata = $rs3_ratapersepsi_count > 0 ? $rs3_ratapersepsi_sum / $rs3_ratapersepsi_count : 0;
        ...
        //$rs4_ratapersepsi_rata = $rs4_ratapersepsi_count > 0 ? $rs4_ratapersepsi_sum / $rs4_ratapersepsi_count : 0;
        ...
        //$rs5_ratapersepsi_rata = $rs5_ratapersepsi_count > 0 ? $rs5_ratapersepsi_sum / $rs5_ratapersepsi_count : 0;
        ...
        //$rs3_ratakepentingan_rata = $rs3_ratakepentingan_count > 0 ? $rs3_ratakepentingan_sum / $rs3_ratakepentingan_count : 0;
        ...
        //$rs4_ratakepentingan_rata = $rs4_ratakepentingan_count > 0 ? $rs4_ratakepentingan_sum / $rs4_ratakepentingan_count : 0;
        ...
        //$rs5_ratakepentingan_rata = $rs5_ratakepentingan_count > 0 ? $rs5_ratakepentingan_sum / $rs5_ratakepentingan_count : 0;
        ...
        $rl3_ratapersepsi_rata = $rl3_ratapersepsi_count > 0 ? $rl3_ratapersepsi_sum / $rl3_ratapersepsi_count : 0;
        */
        ...
        $rl3_ratakepentingan_rata = $rl3_ratakepentingan_count > 0 ? $rl3_ratakepentingan_sum / $rl3_ratakepentingan_count : 0;
*/
        //Applicability ================
        //persepsi
        $rl1_ratapersepsi_sum = DB::table('tbl_jawaban_applicability')->where('kategori','=','persepsi')->sum('ap1');
