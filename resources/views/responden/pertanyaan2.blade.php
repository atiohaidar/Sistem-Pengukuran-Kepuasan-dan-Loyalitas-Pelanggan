        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 mt-5" style="background-color: #40916C">
            ...
            <center><h4 style="color:black;"><b>Aplikasi Survei Kepuasan dan Loyalitas Pelanggan</b></h4></center>
              <br/>
          <form class="form-horizontal" enctype="multipart/form-data"  method="POST" action="{{ route('responden.simpanpertanyaan2') }}">
            @csrf
            ...
            <div class="card card-info">
                <div class="card-header" style="background-color: #95D5B2; color:black;">
                  <h3 class="card-title">III. Penilaian persepsi responden terhadap kinerja kualitas layanan pelatihan </h3>
                </div>
               
                  <div class="card-body">
                    <p>Berikan jawaban yang sesuai dengan persepsi anda. Tentukan seberapa sesuai atribut tersebut di dalam memberikan layanan yang baik kepada anda.<br/> Pilihan jawaban: “Sangat tidak sesuai, tidak sesuai, netral, sesuai, sangat sesuai”.
