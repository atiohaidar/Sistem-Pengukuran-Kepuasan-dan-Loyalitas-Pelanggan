            ...
            <div class="mb-6">
                    ...
                    <div class="flex items-start justify-between">
                        <div>
                            <a href="{{ route('grafik.dashboard-campaign', $campaign->id) }}"
                                class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-red-500 to-red-600 border border-red-500 rounded-lg shadow-sm text-sm font-medium text-white hover:from-red-600 hover:to-red-700 hover:border-red-600 transition-all duration-200">
                ...
                @else
                    <a href="{{ route($type === 'produk' ? 'dashboard.produk' : 'dashboard.pelatihan') }}"
                        class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-red-500 to-red-600 border border-red-500 rounded-lg shadow-sm text-sm font-medium text-white hover:from-red-600 hover:to-red-700 hover:border-red-600 transition-all duration-200 transform hover:scale-105">
                        <i class="fas fa-arrow-left mr-2 text-lg"></i>
                    ...
                    @php
                        ...
                        function renderIKPTable($ikpPercentage, $ikpInterpretation)
                        {
                            ...
                            foreach ($scales as $scale) {
                                $isCurrent = false;
                                if (
                                    ($ikpPercentage >= 81 && $scale['range'] === '81-100') ||
