        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                        ...
                        <div>
                            <dl class="space-y-3">
                                ...
                                <div>
                                    ...
                                    <dd class="mt-1 text-sm text-gray-900">{{ $aggregatedData['total_evaluations'] ?? 'N/A' }}</dd>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <dd class="mt-1 text-sm text-gray-900">{{ $umkm->created_at->format('d/m/Y H:i:s') }}</dd>
                                </div>
                            </dl>
                        </div>
                    </div>
            ...
            @if($totalRespondents > 0)
                <div class="bg-gray-50 overflow-hidden shadow-sm sm:rounded-lg mb-6">
                    <div class="px-6 py-4 bg-gray-100 border-b border-gray-200">
                        <h3 class="text-lg font-medium text-gray-900">Asesmen Maturitas (Rata-rata dari {{ $totalRespondents }} Respondents)</h3>
                    </div>
                    <div class="p-6">
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gray-50">
                                    <tr>
                                        ...
                                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Jumlah Response</th>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr class="bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-bold text-gray-900">{{ $totalRespondents }}</td>
            ...
            @if($totalRespondents > 0)
                <div class="bg-gray-50 overflow-hidden shadow-sm sm:rounded-lg mb-6">
                    <div class="px-6 py-4 bg-gray-100 border-b border-gray-200">
                        <h3 class="text-lg font-medium text-gray-900">Prioritas Implementasi (Rata-rata dari {{ $totalRespondents }} Respondents)</h3>
                    </div>
                    <div class="p-6">
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gray-50">
                                    <tr>
                                        ...
                                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Rata-rata Prioritas (%)</th>
                                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Jumlah Response</th>
            ...
            @if($totalRespondents > 0)
                <div class="bg-gray-50 overflow-hidden shadow-sm sm:rounded-lg mb-6">
                    <div class="px-6 py-4 bg-gray-100 border-b border-gray-200">
                        <h3 class="text-lg font-medium text-gray-900">Tingkat Kesiapan Organisasi (Rata-rata dari {{ $totalRespondents }} Respondents)</h3>
                    </div>
                    <div class="p-6">
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200">
            ...
            @if($totalRespondents > 0 && isset($results['persepsiData']) && count($results['persepsiData']) > 0)
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                    <div class="px-6 py-4 bg-white border-b border-gray-200">
                        ...
                        <p class="text-sm text-gray-600 mt-1">Scatter plot menunjukkan hubungan antara tingkat harapan dan persepsi pelanggan terhadap berbagai aspek CRM</p>
                    </div>
                    <div class="p-6">
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="mt-2 text-sm text-yellow-700">
                                <p>UMKM ini belum memiliki respondents yang mengisi evaluasi CRM. Bagikan link survey berikut kepada stakeholders UMKM:</p>
                                <p class="mt-2 font-mono text-xs bg-yellow-100 p-2 rounded">{{ url('/crm/survey/' . $umkm->crm_token) }}</p>
                            </div>
                        </div>
                    </div>
                </div>
