	...
	<div class="max-w-4xl mx-auto">
		...
		<div class="bg-white shadow-lg rounded-lg p-8 text-center mb-8">
			...
			<p class="text-gray-600 mb-6">
				Masukan dan penilaian Anda akan membantu kami meningkatkan kualitas produk
			...
			<div class="flex justify-center space-x-4">
				...
				<div class="text-center">
					...
					<p class="text-sm text-gray-600">Perbaikan Produk</p>
				</div>
				<div class="text-center">
		...
		<!-- Action Buttons -->
		<div class="text-center">
			<a href="{{ route('survey.produk.index') }}" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-8 rounded-lg text-lg transition duration-300 transform hover:scale-105 shadow-lg inline-block">
