<x-guest-layout title="Penilaian Tingkat Kepentingan - Survei Kepuasan Produk">
	...
	<div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
		...
		<div class="bg-white shadow-lg rounded-lg overflow-hidden">
			<div class="bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-4">
				<h2 class="text-2xl font-bold text-white">II. Penilaian Tingkat Kepentingan / Harapan responden terhadap kualitas produk</h2>
				<p class="text-blue-100 mt-1">Berikan jawaban yang sesuai dengan preferensi anda. Tentukan seberapa penting atribut tersebut memengaruhi Anda dalam menggunakan produk ini</p>
			</div>

			<form method="POST" action="{{ route('survey.produk.store', ['step' => 'harapan']) }}" class="p-6">
				@csrf
				...
				<div class="mb-8">
					...
					<div class="space-y-4">
						...
						@php
	// Helper: render select for harapan. Default to '0' to avoid empty-string validation failures
