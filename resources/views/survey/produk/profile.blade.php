<x-guest-layout title="Profil Responden - Survei Kepuasan Produk">
<div class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-8">
	<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
		...
		<div class="bg-white shadow-lg rounded-lg overflow-hidden">
			...
			<form method="POST" action="{{ route('survey.produk.store', ['step' => 'profile']) }}" class="p-6">
				@csrf
...
document.addEventListener('DOMContentLoaded', function() {
	...
	if (pekerjaanSelect && pekerjaanSelect.value === 'Lainnya') {
		const container = document.getElementById('pekerjaan_lain_container');
