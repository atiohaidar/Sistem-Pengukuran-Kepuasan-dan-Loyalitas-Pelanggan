                ...
                <div class="relative bg-white sm:rounded-2xl p-8">
                    <div class="text-center">
                        ...
                        <p class="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed mb-6">
                            Akses berbagai analisis dan laporan terkait hasil survey kepuasan dan loyalitas pelanggan produk.
                        </p>
            ...
            <div class="text-center mt-12 animate-fade-in" style="animation-delay: 0.6s;">
                <div class="bg-white/50 backdrop-blur-sm rounded-2xl p-6 shadow-lg">
                    ...
                    <p class="text-sm text-gray-600 leading-relaxed">
                        Dashboard ini menyediakan berbagai analisis komprehensif untuk memahami kepuasan dan loyalitas pelanggan produk.
                        Gunakan data ini untuk pengambilan keputusan yang lebih baik dalam pengembangan produk.
                    </p>
                </div>
            </div>
        </div>
