                    ...
                    <div class="flex items-start justify-between">
                        <div>
                            <a href="{{ route('grafik.dashboard-campaign', $campaign->id) }}"
                                class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-500 to-blue-600 border border-blue-500 rounded-lg shadow-sm text-sm font-medium text-white hover:from-blue-600 hover:to-blue-700 hover:border-blue-600 transition-all duration-200">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            @foreach($questions['kepuasan_answers'] as $key => $question)
                                <div
                                    class="bg-gradient-to-r from-{{ $colors[$i % 3] }}-50 to-{{ $colors[$i % 3] }}-100 rounded-xl p-6 border border-{{ $colors[$i % 3] }}-200">
                                    <div class="text-center">
                                        <div class="text-2xl font-bold text-{{ $colors[$i % 3] }}-600 mb-3">
                                            {{ strtoupper($key) }}</div>
                                        <div class="text-lg font-semibold text-gray-800 mb-3">{{ ucfirst($key) }} Question
                                        </div>
