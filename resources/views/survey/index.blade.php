    ...
    <div class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-white rounded-xl shadow-xl p-8 mb-8 border border-gray-100">
                <div class="text-center mb-6">
                    <div
                        class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full mb-4">
        ...
        <div class="text-center">
            ...
            <p class="text-gray-500 mt-6 text-sm max-w-md mx-auto leading-relaxed">
                Dengan mengklik tombol di atas, Anda menyetujui untuk mengisi survei ini dengan jujur dan bertanggung
                jawab
            </p>
        </div>
