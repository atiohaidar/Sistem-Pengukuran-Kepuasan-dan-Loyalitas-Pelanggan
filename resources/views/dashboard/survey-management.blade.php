    ...
    <div class="py-12 bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-2xl sm:rounded-2xl border-0 relative animate-fade-in">
                ...
                <div
                    class="absolute inset-0 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 rounded-2xl opacity-10">
                </div>
                ...
                <div class="relative bg-white sm:rounded-2xl p-8">
                    ...
                    <div class="flex justify-between items-center mb-8">
                        <div class="flex items-center">
                            ...
                            <div>
                                <h3
                                    ...
                                    Manajemen Data Survei {{ ucfirst($type) }}</h3>
                                <p class="mt-1 text-sm text-gray-600">
                                    Kelola data survei responden |
                                    <a href="{{ $type === 'produk' ? route('survey.produk.index') : route('survey.pelatihan.index') }}"
                        ...
                        <a href="{{ route('dashboard.survey-management.export', $type) }}"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                        <div
                            class="bg-white overflow-hidden shadow-2xl sm:rounded-2xl border-0 relative animate-fade-in">
                            <div
                                class="absolute inset-0 bg-gradient-to-r from-blue-500 to-blue-600 rounded-2xl opacity-10">
                            </div>
                            <div class="relative bg-white sm:rounded-2xl p-6">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0">
                                        <div
                                            class="bg-gradient-to-r from-blue-500 to-blue-600 p-3 rounded-full mr-4 shadow-lg">
                                    ...
                                    <div class="flex-1">
                                        <dl>
                                            ...
                                            <dd class="text-3xl font-bold text-gray-900">{{ $stats['total_responses'] }}
                                            </dd>
                                        </dl>
                                    </div>
                                </div>
                        ...
                        <div
                            class="bg-white overflow-hidden shadow-2xl sm:rounded-2xl border-0 relative animate-fade-in">
                            <div
                                class="absolute inset-0 bg-gradient-to-r from-green-500 to-green-600 rounded-2xl opacity-10">
                            </div>
                            <div class="relative bg-white sm:rounded-2xl p-6">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0">
                                        <div
                                            class="bg-gradient-to-r from-green-500 to-green-600 p-3 rounded-full mr-4 shadow-lg">
                                            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div
                            class="bg-white overflow-hidden shadow-2xl sm:rounded-2xl border-0 relative animate-fade-in">
                            <div
                                class="absolute inset-0 bg-gradient-to-r from-yellow-500 to-yellow-600 rounded-2xl opacity-10">
                            </div>
                            <div class="relative bg-white sm:rounded-2xl p-6">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0">
                                        <div
                                            class="bg-gradient-to-r from-yellow-500 to-yellow-600 p-3 rounded-full mr-4 shadow-lg">
                                            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    ...
                                    <div class="flex-1">
                                        <dl>
                                            ...
                                            <dd class="text-3xl font-bold text-gray-900">{{ $stats['draft_responses'] }}
                                            </dd>
                                        </dl>
                                    </div>
                                </div>
                        ...
                        <div
                            class="bg-white overflow-hidden shadow-2xl sm:rounded-2xl border-0 relative animate-fade-in">
                            <div
                                class="absolute inset-0 bg-gradient-to-r from-purple-500 to-purple-600 rounded-2xl opacity-10">
                            </div>
                            <div class="relative bg-white sm:rounded-2xl p-6">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0">
                                        <div
                                            class="bg-gradient-to-r from-purple-500 to-purple-600 p-3 rounded-full mr-4 shadow-lg">
                                            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    ...
                                    <div class="flex-1">
                                        <dl>
                                            ...
                                            <dd class="text-3xl font-bold text-gray-900">{{ $stats['unique_sessions'] }}
                                            </dd>
                                        </dl>
                                    </div>
                                </div>
                    ...
                    <div class="bg-white overflow-hidden shadow-2xl sm:rounded-2xl border-0 relative animate-fade-in">
                        <div
                            class="absolute inset-0 bg-gradient-to-r from-gray-500 via-slate-500 to-gray-500 rounded-2xl opacity-5">
                        </div>
                                            ...
                                            <tr
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                    @if($response->profile_data['jenis_kelamin'] ?? null)
                                                        <span class="inline-flex items-center">
                                                            <i
                                                                class="fas fa-{{ $response->profile_data['jenis_kelamin'] === 'L' ? 'mars' : 'venus' }} mr-1 text-{{ $response->profile_data['jenis_kelamin'] === 'L' ? 'blue' : 'pink' }}-500"></i>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <span
                                                        ...
                                                        <i
                                                            class="fas fa-{{ $response->status === 'completed' ? 'check-circle' : 'edit' }} mr-1"></i>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                    <div class="flex space-x-2">
                                                        ...
                                                        <form
                                                            action="{{ route('dashboard.survey-management.destroy', [$type, $response->id]) }}"
                                            ...
                                            <tr>
                                                <td colspan="9" class="px-6 py-8 text-center text-gray-500">
                                                    <div class="flex flex-col items-center">
                                                        ...
                                                        <h3 class="text-lg font-medium text-gray-900 mb-2">Belum ada data
                                                            survei</h3>
                                                        <p class="text-gray-500">Data survei akan muncul di sini setelah
                                                            responden mengisi formulir.</p>
                                                    </div>
                                                </td>
                                            </tr>
                                        @endforelse
                    ...
                    @if($surveyResponses->hasPages())
                        <div
                            class="mt-8 bg-white overflow-hidden shadow-2xl sm:rounded-2xl border-0 relative animate-fade-in">
                            <div
                                class="absolute inset-0 bg-gradient-to-r from-gray-500 via-slate-500 to-gray-500 rounded-2xl opacity-5">
                            </div>
                            <div class="relative bg-white sm:rounded-2xl p-6">
